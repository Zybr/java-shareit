...
public interface BookingRepository extends JpaRepository<Booking, Long> {
    ...
    Optional<Booking> findByItemOwnerIdAndStatusAndEndBeforeOrderByEndDesc(Long bookerId, BookingStatus status, LocalDateTime end);

    Optional<Booking> findByItemOwnerIdAndStatusAndStartAfterOrderByStartAsc(Long bookerId, BookingStatus status, LocalDateTime start);
