...
public class BookingServiceTest extends DbTestCase {
    ...
    @Test
    void findAllByBookerVariousStates() {
    ...
    @Test
    void findAllByItemOwnerVariousStates() {
    ...
    @Test
    void createOneItemNotAvailable() {
